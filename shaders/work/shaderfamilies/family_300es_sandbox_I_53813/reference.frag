...
{
 uv = vec2(atan(uv.y, uv.x) / 3.14159265 * opt.kappa + time * opt.omega + opt.phi, fit01(opt.minRadius, opt.maxRadius, length(uv)) * 2. - 1.);
...
{
 float len = 3.14159265 * .14 + .11 * 2. + 3.14159265 * .14 + .11 * 2.;
 vec2 cc = vec2(.14, .11);
 float theta;
 ...
 float a4 = fit01((.44 + 3.14159265 * .14) / len, 1., fract(anim));
 theta = 3.14159265 * a2;
 vec2 cc2 = vec2(.0, .11) + .14 * vec2(cos(theta), sin(theta));
 theta = 3.14159265 + 3.14159265 * a4;
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
 ...
 col = dots(col, uv, d);
 dist = max(dist, d);
 col = horn14(col, uv, mainEye, dh15, d);
 dist = max(dist, d);
 col = mix(col, horn15Layer, fill(dh15));
 dist = max(dist, dh15);
 col = horn16(col, uv, mainEye, d);
 dist = max(dist, d);
 col = horn17(col, uv, mainEye, dh11, dh9, d);
 dist = max(dist, d);
 ...
 dist = max(dist, d);
 col = horn1(col, uv, mainEye, dh4, d);
 dist = max(dist, d);
 col = horn5(col, uv, dh4, d);
 dist = max(dist, d);
 col = horn2(col, uv, mainEye, dh4, d);
 dist = max(dist, d);
 ...
 dist = max(dist, d);
 col = horn13(col, uv, dist, d);
 dist = max(dist, d);
 col = horn7(col, uv, mainEye, d);
 dist = max(dist, d);
 col = mix(col, mainEyeLayer, fill(mainEye));
 dist = max(dist, mainEye);
 col = mix(col, subEyesLayer, fill(subEyes));
 dist = max(dist, subEyes);
