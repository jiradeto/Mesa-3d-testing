...
const vec2 ch_size  = vec2(1, 2.0);              	// character size
...
void main( void ) 
{
	...
	ch_pos.x += 1.0; 
	ch_pos.y += 3.0;
	H E L L _ Y E A s_comma
	
	ch_pos.y -= 6.0;
	ch_pos.x = -14.0;
	T H O S E _ F U C K S _ D O N s_apos T 
		
	ch_pos.y -= 3.0;
	ch_pos.x = -14.0;
	_ E V E N _ K N O W _ H O W _ T O 
		
	ch_pos.y -= 3.0;
	ch_pos.x = -14.0;
	_ U S E _ s_aposl R s_apos _ A N D _ s_aposl P s_apos
