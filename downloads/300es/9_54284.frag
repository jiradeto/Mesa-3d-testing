...
void main() {
	...
	d = min(d,L(uv2-vec2(-2.5,1.5)));
	d = min(d,O(uv2-vec2(-2.0,1.5)));
	d = min(d,G(uv2-vec2(-1.5,1.5)));
	d = min(d,A(uv2-vec2(-1.0,1.5)));
	d = min(d,N(uv2-vec2(-0.5,1.5)));
