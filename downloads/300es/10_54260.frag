...
uniform vec2 injectionSwitch;// goodSHIT
...
{	
	...
	d = min(d,G(uv-vec2(-2.5,1.5)));
	d = min(d,O(uv-vec2(-2.0,1.5)));
	d = min(d,O(uv-vec2(-1.5,1.5)));
	d = min(d,D(uv-vec2(-1.0,1.5)));
	d = min(d,S(uv-vec2(-0.5,1.5)));
	d = min(d,H(uv-vec2(0.0,1.5)));
	d = min(d,I(uv-vec2(.5,1.5)));
	d = min(d,T(uv-vec2(1.0,1.5)));
