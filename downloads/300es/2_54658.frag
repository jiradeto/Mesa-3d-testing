...
uniform vec2 injectionSwitch;//flower.glsl
precision highp float;
uniform float time;
...
void main()
{
	...
	_GLF_color += vec4(circle1Color * circle1, 1.0);
	...
	_GLF_color += vec4(circle2Color * circle2, 1.0);
	...
	_GLF_color += vec4(circle3Color * circle3, 1.0);
	...
	_GLF_color += vec4(circle4Color * circle4, 1.0);
